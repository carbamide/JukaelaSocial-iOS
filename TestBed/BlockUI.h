...
#define kActionSheetTitleFont           [UIFont fontWithName:kHelveticaLight size:18]
...
#define kActionSheetButtonFont          [UIFont fontWithName:kHelveticaLight size:20]
...
#define kAlertViewTitleFont             [UIFont fontWithName:kHelveticaLight size:20]
...
#define kAlertViewMessageFont           [UIFont fontWithName:kHelveticaLight size:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:kHelveticaLight size:18]
