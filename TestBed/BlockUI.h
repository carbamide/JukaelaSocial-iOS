...
#define kActionSheetTitleFont           [UIFont fontWithName:@"Helvetica-Light" size:18]
...
#define kActionSheetButtonFont          [UIFont fontWithName:@"Helvetica-Light" size:20]
...
#define kAlertViewTitleFont             [UIFont fontWithName:@"Helvetica-Light" size:20]
...
#define kAlertViewMessageFont           [UIFont fontWithName:@"Helvetica-Light" size:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:@"Helvetica-Light" size:18]
