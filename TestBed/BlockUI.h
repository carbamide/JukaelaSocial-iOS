...
#define kActionSheetTitleFont           [UIFont fontWithName:kFontPreference size:18]
...
#define kActionSheetButtonFont          [UIFont fontWithName:kFontPreference size:20]
...
#define kAlertViewTitleFont             [UIFont fontWithName:kFontPreference size:20]
...
#define kAlertViewMessageFont           [UIFont fontWithName:kFontPreference size:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:kFontPreference size:18]
