...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if ([indexPath section] == 0) {
            ...
            if ([indexPath row] == 0) {
                ...
                [_username setFont:[UIFont preferredFontForTextStyle:UIFontTextStyleHeadline2]];
                ...
                [_password setFont:[UIFont preferredFontForTextStyle:UIFontTextStyleHeadline2]];
    ...
    [[_rememberUsername titleLabel] setFont:[UIFont preferredFontForTextStyle:UIFontTextStyleHeadline2]];
