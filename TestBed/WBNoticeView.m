                       ...
                       yOrigin:(CGFloat)origin
{
    ...
    self.titleLabel.font = [UIFont fontWithName:kFontPreference size:14];
    ...
    self.messageLabel.font = [UIFont fontWithName:kFontPreference size:13];
                        ...
                        yOrigin:(CGFloat)origin
{
    ...
    self.titleLabel.font = [UIFont fontWithName:kFontPreference size:12];
    self.titleLabel.backgroundColor = [UIColor clearColor];
    self.titleLabel.text = title;
